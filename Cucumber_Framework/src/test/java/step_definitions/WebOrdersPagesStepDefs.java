...
public class WebOrdersPagesStepDefs extends BaseStep {
    ...
    public void the_user_logs_out_and_navigates_to_the_login_page() {
        Assert.assertEquals(pages.loginPage().getCurrentUrl(), "http://secure.smartbearsoftware.com/samples/TestComplete12/" +
